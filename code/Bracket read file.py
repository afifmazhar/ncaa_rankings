...
df1 = pd.read_csv(os.path.join("C:/Users/madwo/ncaa_rankings/data/clean", "2022_teams.csv"))
df2 = pd.read_csv(os.path.join("C:/Users/madwo/ncaa_rankings/data/clean", "team-ratings.csv"))
...
bracket_data.to_csv(os.path.join("C:/Users/madwo/ncaa_rankings/data/clean", "bracket_data.csv"), index = False)